...
class review(TypedDict):
    ...
    reviewer_name: Annotated[str, "The name of the reviewer"]
    review_date: Annotated[str, "The date when the review was written"]

model = ChatOpenAI()
structed_model = model.with_structured_output(review)
response = model.invoke("""I recently upgraded to the Samsung Galaxy S24 Ultra, and I must say, it’s an absolute powerhouse! The Snapdragon 8 Gen 3 processor makes everything lightning fast—whether I’m gaming, multitasking, or editing photos. The 5000mAh battery easily lasts a full day even with heavy use, and the 45W fast charging is a lifesaver.
